        ...
        alerts.append(
            {
                ...
                "message": (
                    "No code-hunt digest on disk — run run_codehunt_scan_tool or "
                    "install_codehunt_tasks.ps1"
                ),
            ...
            alerts.append(
                {
                    ...
                    "message": (
                        f"Last code-hunt digest is {age_h}h old "
                        f"(threshold {stale_hours}h) — scan loop may be dead"
                    ),
