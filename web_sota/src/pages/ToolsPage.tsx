  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        const data = await apiGet<{ tools: Tool[]; tool_count?: number }>("/api/tools");
    ...
    (async () => {
      ...
      try {
        ...
        const data = await apiGet<Caps>("/api/capabilities");
    ...
    <div className="space-y-6">
      ...
      {caps?.features ? (
        ...
        <Card>
          ...
          <pre className="mt-2 text-[11px] overflow-x-auto text-muted-foreground">{JSON.stringify(caps.features, null, 2)}</pre>
