  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-center gap-2">
        ...
        {hasClaims && (
          <span className="text-[11px] rounded bg-secondary px-1.5 py-0.5 text-muted-foreground">
  ...
  return (
    <div className="space-y-6" data-testid="depot-page">
      <PageHero
        ...
        title="Depot"
        lead="Ingested papers, epistemic profiles, and full text."
        size="default"
      />
      ...
      <Card data-testid="depot-ingest">
        ...
        <p className="mt-2 text-xs text-muted-foreground">
          Deep analyze needs Ollama or MCP sampling.
        </p>
      </Card>
      ...
      <div className="flex items-center gap-2">
        ...
        <p className="text-xs text-muted-foreground">
          {rows.length} paper{rows.length !== 1 ? "s" : ""} in depot
        </p>
      </div>
            ...
            {rows.map((r) => (
              ...
              >
                <div className="flex flex-wrap items-center gap-1.5">
                  ...
                  {r.primary_mode && (
                    <span className="text-[11px] capitalize text-muted-foreground bg-muted/50 px-1 rounded">
                ...
                <div className="text-sm line-clamp-1 mt-0.5">{r.title}</div>
              </button>
            ))}
          </div>
        </Card>
            ...
            <div className="mt-3 space-y-3">
              ...
              {readerTab === "profile" &&
                (profile ? (
                  ...
                  <p className="text-xs text-muted-foreground">
                    No epistemic profile — use Ingest + deep analyze.
                  </p>
                ))}
              {readerTab === "text" && (
